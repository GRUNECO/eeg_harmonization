...
#print(files_error_huber)
    ...
    return ff_raw,sbj_raw,Pxx_comp_raw,ff_preprocessing,sbj_preprocessing,Pxx_comp_preprocessing,ff_trim,sbj_trim,Pxx_comp_trim,ff_trim_nolp,sbj_trim_nolp,Pxx_comp_trim_nolp,ff_huber,sbj_huber,Pxx_comp_huber  
    
ff_raw,sbj_raw,Pxx_comp_raw,ff_preprocessing,sbj_preprocessing,Pxx_comp_preprocessing,ff_trim,sbj_trim,Pxx_comp_trim,ff_trim_nolp,sbj_trim_nolp,Pxx_comp_trim_nolp,ff_huber,sbj_huber,Pxx_comp_huber = BIDS_pds(THE_DATASET_)  

f, (ax1,ax4,ax5,ax6,ax7) = plt.subplots(5, 1,sharex=True, sharey=False)
