...
for space in s:
    ...
    #    for allb in b:  
        ...
        new_sovaname = 'Data_complete_'+space+'_sovaharmony_G1Gen_'+allm
        path_save_feather = path_feather + fr'\sovaharmony\complete\{space}\G1Gen'
        ...
        new_name = 'Data_complete_'+space+'_neuroHarmonize_G1Gen_'+allm
        path_save_feather = path_feather + fr'\neuroHarmonize\complete\{space}\G1Gen'
        os.makedirs(path_save_feather,exist_ok=True)
