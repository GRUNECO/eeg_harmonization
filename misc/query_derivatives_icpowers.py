...
eegs_powers = [x for x in eegs_powers if f'desc-component[{runlabel}]_powers_norm' in x]
...
df.to_excel(r'E:\Academico\Universidad\Posgrado\Tesis\Datos\longitudinal_data_icpowers_norm_'+name+'.xlsx')
