...
#from datasets import DUQUE as THE_DATASET

def get_dataframe_columnsROI(THE_DATASET): 
    ...
    df.to_feather(r'{input_path}\derivatives\data_powers_column_ROI_norm_{name}.feather'.format(name=name,input_path=input_path))
    print('Done!')

#Se debe escribir el dataset a usar
THE_DATASET = {
    'name':'SRM',
...
get_dataframe_columnsROI(THE_DATASET)
