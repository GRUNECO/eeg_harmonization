...
path = r'C:\Users\veroh\OneDrive - Universidad de Antioquia\Datos_MsC_Veronica\CHBMP\derivatives\sovaharmony'
name = ['_eeg','trim[restCE]_eeg','trim_nolp[restCE]_eeg','norm_eeg','powers_norm','sl_norm','band_norm','coherence_norm','entropy_norm','entropy_band_norm']
ext = ['.fif','.json','.txt']
...
remove_data_without_visits(path,name[9],ext[0])
remove_data_without_visits(path,name[9],ext[1])
remove_data_without_visits(path,name[9],ext[2])
