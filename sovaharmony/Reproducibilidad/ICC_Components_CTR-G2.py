...
for st in Stage:
    ...
    icc_value.append(icc_value)
#print(icc_value)
icc_value.to_csv(r'E:\Academico\Universidad\Posgrado\Tesis\Paquetes\eeg_harmonization\sovaharmony\Reproducibilidad\icc_values_Components_G2-CTR.csv',sep=';')
